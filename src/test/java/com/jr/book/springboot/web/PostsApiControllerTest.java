...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT) //webMvcTest와 차이?
public class PostsApiControllerTest {
    ...
    @Autowired
    private TestRestTemplate restTemplate; //MockMvc와의 차이?
    ...
    public void Posts_등록된다() {
        ...
        assertThat(responseEntity.getBody()).isGreaterThan(0L); //뒤에 인수로 오는 값보다 앞에 오는 게 더 크다 라는 의미
    ...
    public void Posts_수정된다() throws Exception {
        ...
        //then
        assertThat(responseEntity.getStatusCode()).isEqualTo(HttpStatus.OK); // 응답이 성공
        assertThat(responseEntity.getBody()).isGreaterThan(0L); // 리턴값이 있을 때
